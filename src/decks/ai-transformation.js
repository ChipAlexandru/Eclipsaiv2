  ...
  chapters: [
    {
      ...
      slides: [
        ...
        },
        {
          ...
          type: "standard",
          title: "AI is now operating priority for top banks. Only a third disclose outcomes",
          source: "JPMorgan, HSBC, Goldman Sachs, DBS, UBS, Evident Insights",
          pillars: [
            { title: "JPMorgan: USD 2B AI savings match AI spend", desc: "Annual AI spend matched by annual AI savings (Dimon, Oct 2025). 150,000 employees use internal AI weekly. 10-11% productivity gain in engineering, operations, fraud." },
            ...
            { title: "UBS: 300+ live AI use cases", desc: "M365 Copilot + Red rolling to all employees. 280+ AI use cases live as of Q2 2025 (+10% QoQ). Magazzeni (ex-JPM EMEA) appointed Chief AI Officer effective Jan 2026." },
            { title: "Goldman Sachs: 46,500 knowledge workers invited", desc: "Invited to GS AI Assistant after Jun 2025 firmwide launch (10,000 in pilot from Jan 2025). Multi-model routing across OpenAI, Gemini, Llama." },
          ...
          article: {
            ...
            sections: [
              ...
              { subhead: "JPMorgan: the public AI-disclosure benchmark", body: "Jamie Dimon disclosed in October 2025 that annual AI savings now match annual AI spend, the strongest public AI-ROI statement from any US bank CEO. 150,000 employees use internal AI tools weekly. JPM has measured 10-11% productivity gains across engineering, operations, and fraud functions." },
              { body: "Teresa Heitsenrether appointed Chief Data & Analytics Officer in June 2023 to lead AI. LLM Suite released to 140,000 employees in August 2024 as the proprietary GenAI platform. By early 2025, 200,000 users were onboarded in 8 months alongside IndexGPT for client-facing thematic investing. The platform won American Banker 'Innovation of the Year' (Generative AI) in June 2025." },
              { body: "JPM has ranked #1 on the Evident AI Index for four consecutive years. Peer-validated rather than self-reported. The 2024 technology budget is USD 17B. 450+ AI proofs of concept are in flight; 500+ active use cases are in production." },
            ...
            sources: [
              { label: "Bloomberg: Dimon — AI cost savings now match spend (Oct 2025)", url: "https://www.bloomberg.com/news/articles/2025-10-14/jpmorgan-jpm-dimon-says-ai-cost-savings-now-match-spending" },
    ...
    },
    {
      ...
      slides: [
        ...
        },
        {
          ...
          pillars: [
            { title: "What they do", desc: "You describe an outcome. The system reads your files, pulls context from connected tools, performs the work, and delivers a finished result." },
            { title: "Early implementation", desc: "Zapier deployed across marketing, engineering operations, and influencer teams. Thomson Reuters piloted for legal." },
            { title: "What works", desc: "Multi-source synthesis from documents, reusable workflows saved as skill files, operational dashboards pulling from multiple data systems, document and slide generation tied to source files." },
            { title: "What does not work yet", desc: "No audit logs or compliance exports on either product. Neither cleared for regulated workloads." },
          ],
          callout: {
            text: "The destination is a desktop agent that does all computer work.",
          },
          article: {
            title: "I run most of my work through Cowork/Codex because they extend what I do and how fast I do it",
            sections: [
              { body: "Anthropic launched Cowork in January 2026 as a knowledge work product. OpenAI repositioned Codex from a coding agent into a general work platform between February and April 2026." },
              { body: "I have used both since launch and run approximately 90% of my professional work through one, the other, or both." },

              { subhead: "AI models are smart enough, the product harness gives them tools, and my skills make them work for me", body: "You describe a task, or better yet an outcome. The system coordinates work across files, tools, and data to deliver a finished result. That description applies equally to Cowork and Codex in their current form." },
              { body: "The architecture has three layers. First, a frontier language model (Claude Opus or Sonnet for Cowork, GPT-5.4 or GPT-5.5 for Codex)." },
              { body: "Second, an agentic harness that manages file system access, a code execution environment, enterprise connectors (Google Drive, Slack, Salesforce, Microsoft 365), computer use, and multi-step task orchestration." },
              { body: "**Third, a customization layer of reusable skills and plugins that encode how specific tasks are done: a performance review workflow, a contract triage process, a research protocol, a slide-building method.**" },
              { body: "The skills layer is where the practical value compounds. A skill is a set of instructions, saved as a file, that tells the system how to perform a specific task. Once written, it runs the same way every time, can be shared across a team, improved through iteration, and versioned like code. Anthropic shipped 11 open-source role plugins (sales, finance, legal, marketing, HR, operations, data) in January 2026. OpenAI launched 90+ plugins in April 2026. Both maintain plugin marketplaces." },
              { body: "Eric Porres, Chief AI Officer at Logitech, runs both tools and argues that these markdown skill files have become the new code: the unit of work that knowledge workers create, maintain, and improve." },

              { subhead: "AI labs realized that chat alone is limited, so they built products that add context, instructions, and tools", body: "Anthropic announced Cowork on January 12, 2026, branded as “Claude Code power for knowledge work.” The product page, the plugin pack, and the enterprise launch event in February all framed Cowork around non-engineering functions: legal, sales, finance, marketing, HR, operations. By April 2026, Anthropic reported that the majority of Cowork usage comes from outside engineering teams, with operations, marketing, finance, and legal as the primary adopters." },
              { body: "OpenAI introduced the Codex desktop app on February 2, 2026, still primarily positioned for software creation, but with a new argument: “the better an agent is at reasoning about and producing code, the more capable it becomes across all forms of technical and knowledge work.”" },
              { body: "The explicit pivot came on April 16, 2026, when OpenAI published “Codex for (almost) everything,” adding computer use, memory, browser access, and 90+ plugins. Six days later, workspace agents launched inside ChatGPT: shared, Codex-powered agents for finance, sales, and marketing workflows, deployable via Slack. Sam Altman said “try it for non-coding computer work.” Greg Brockman said “Codex is for everyone, for any task done with a computer.”" },

              { subhead: "Early-mover enterprises are implementing new ways of working", body: "Zapier deployed Cowork across three teams. Product marketing rewrites a homepage from a positioning brief in 15 minutes. An engineering operations analyst ran 15 SQL queries across six systems (GitLab, Jira, Productboard, OpsLevel, Jellyfish, Databricks) in a single Cowork session to build a bottleneck dashboard. The influencer marketing team built a live dashboard on GitHub Pages that guides budget allocation." },
              { body: "Thomson Reuters piloted Cowork for its next-generation CoCounsel legal product. PayPal discussed a phased Cowork rollout with role-based access and governance controls in a public webinar. Box reported that Claude Opus 4.6 improved multi-source legal, financial, and technical analysis by 10 points in its enterprise evaluations." },
              { body: "On the Codex side, CyberAgent is the strongest public non-coding case. The company uses Codex to pressure-test design proposals, generate alternative suggestions, write specifications, and create mockups, supporting non-developer roles adjacent to product teams." },

              { subhead: "What works well: multi-source synthesis and reusable workflows", body: "From my own daily use, the tasks where both tools perform well share a pattern: you point the system at a folder of source material, describe the outcome you need, and let it coordinate the work." },
              { body: "The system reads the relevant files, pulls context from connected tools, performs the analysis or production task, and delivers a finished result." },
              { body: "The strongest documented capabilities across both products are research synthesis from multiple documents, structured extraction from contracts and records, operational dashboards pulling from several data systems, document and slide generation tied to source files, and guided workflows that previously required lightweight custom applications." },
              { body: "The second layer of value comes from the workflow capture I described at the start. When a task works, you save the instructions as a skill. The next time that task arises, the skill runs it faster and with more consistency. Over time, a team builds a library of skills that encode institutional knowledge: how this company triages contracts, how this team prepares board materials, how this function runs its weekly analysis. The skill improves with each iteration, just like code." },

              { subhead: "What does not work yet: governance and AI agent performance at team level", body: "Both products can do the work. The constraint is whether the organization can govern the work safely. As of April 2026, Cowork activity is excluded from Anthropic's audit logs, Compliance API, and data exports. Anthropic explicitly tells customers not to use Cowork for regulated workloads. OpenTelemetry instrumentation was added at general availability, but Anthropic notes it is not a replacement for audit logging." },
              { body: "Codex's computer use and Chronicle memory features were unavailable in the EU and UK at the April 2026 launch. Chronicle memories are stored as unencrypted markdown files on disk. VentureBeat documented six AI-agent security compromises across Claude Code, Copilot, and Codex in nine months, all targeting runtime credentials." },
              { body: "Both products share the same documented failure modes: prompt injection risk (acknowledged by both vendors), scope creep on agentic actions (Cowork consumed 11GB of files in an early testing incident), and uneven UX for users who are not engineers." },
              { body: "Practitioner sentiment across Mollick, Willison, Ball, and Mowshowitz is consistent: positive on capability, concerned that rollout is faster than the controls." },

              { subhead: "The destination: a desktop agent that does all computer work", body: "Most informed practitioners end up running both tools. I do the same. The reality is that if the work context is well structured, switching from one to the other is seamless." },
              { body: "The destination is clear: a desktop agent that handles any knowledge work task." },
            ],
            sources: [
              { label: "Anthropic: Introducing Labs (January 13, 2026)", url: "https://anthropic.com/news/introducing-anthropic-labs" },
              { label: "Anthropic: Making Claude Cowork ready for enterprise (April 2026)", url: "https://claude.com/blog/cowork-for-enterprise" },
              { label: "Anthropic: Use plugins in Claude Cowork (April 9, 2026)", url: "https://support.claude.com/en/articles/13837440-use-plugins-in-claude-cowork" },
              { label: "Anthropic: Use Claude Cowork safely (April 2026)", url: "https://support.claude.com/en/articles/13364135-use-claude-cowork-safely" },
              { label: "Anthropic: Claude Opus 4.6 and Sonnet 4.6 release notes (February 2026)", url: "https://anthropic.com/news/releases" },
              { label: "OpenAI: Introducing the Codex app (February 2, 2026)", url: "https://openai.com/index/introducing-the-codex-app" },
              { label: "OpenAI: Codex for (almost) everything (April 16, 2026)", url: "https://openai.com/index/codex-for-almost-everything" },
              { label: "OpenAI: Workspace agents in ChatGPT (April 22, 2026)", url: "https://openai.com/index/workspace-agents-chatgpt" },
              { label: "OpenAI: Scaling Codex to enterprises worldwide (2026)", url: "https://openai.com/index/scaling-codex-to-enterprises" },
              { label: "OpenAI Academy: What is Codex? (2026)", url: "https://openai.com/academy/what-is-codex" },
              { label: "Anthropic/Zapier: Customer story (April 1, 2026)", url: "https://claude.com/customers/zapier" },
              { label: "Anthropic/Jamf: Customer story (March 31, 2026)", url: "https://claude.com/customers/jamf" },
              { label: "OpenAI/CyberAgent: Customer story (April 9, 2026)", url: "https://openai.com/index/cyberagent/" },
              { label: "Simon Willison: First impressions of Claude Cowork (January 12, 2026)", url: "https://simonwillison.net/2026/Jan/12/claude-cowork/" },
              { label: "Eric Porres: Knowledge Work Is Code (2026)", url: "https://promptedbyeric.substack.com/p/knowledge-work-is-code-how-to-build" },
              { label: "Ben Thompson/Stratechery: Agents Over Bubbles (2026)", url: "https://stratechery.com" },
              { label: "Ethan Mollick: Claude Cowork evaluations (January–April 2026)", url: "https://www.oneusefulthing.org" },
              { label: "Zvi Mowshowitz: Claude Coworks series (January–April 2026)", url: "https://thezvi.substack.com" },
              { label: "Latent Space: Codex for Knowledge Work, Claude for Creative Work (April 2026)", url: "https://www.latent.space" },
              { label: "Computerworld: M365 Copilot gets its own version of Claude Cowork (March 2026)", url: "https://www.computerworld.com" },
              { label: "VentureBeat: Six AI-agent security compromises in nine months (2026)", url: "https://www.venturebeat.com" },
            ],
          },
        },
        {
          ...
          article: {
            ...
            sections: [
              { body: "An AI work platform is a desktop app with access to a language model. It has persistent memory, direct file system access, connectors to enterprise applications, and a code execution environment that can run scheduled tasks. You describe an outcome. The system coordinates work across files, tools, and data sources to deliver a finished result." },
              ...
              { body: "Product managers, finance analysts, and legal teams adopted Claude Code throughout late 2025. Cowork launched in 2026 and simplified access for non-technical roles. Adoption spread through practitioner channels. Investment firms published tactical playbooks for Claude in portfolio work. Finance leadership communities ran sessions on Cowork workflows. Legal publications covered Cowork as a competitive alternative to vertical AI tools." },
              ...
              { body: "**Available on Pro, Max, Team, and Enterprise plans.** Team and Enterprise tiers add org-level connector permissions and per-tool controls. Access is role-based, managed through your existing identity provider. Spend limits can be set per group. A usage analytics API and security event logging integrate with your existing monitoring tools." },
            ],
            sources: [
